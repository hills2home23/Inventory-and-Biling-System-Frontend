          ...
          <Dropdown alignRight as="li" className="nav-item">
            <Dropdown.Toggle as="a" className="nav-link cursor-pointer no-caret">
              <div className="navbar-profile">
                ...
                {auth.isauthenticated?<p className="mb-0 d-none d-sm-block navbar-profile-name"><Trans>{auth.employee.name}</Trans></p>:<p className="mb-0 d-none d-sm-block navbar-profile-name"><Trans>Henry Klein</Trans></p>}
